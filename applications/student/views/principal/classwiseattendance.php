...
<html>
<head>
    <title>Classwise Attendance</title>
...
<body style="background: white;">
  ...
  <div class="col-xs-11" style="padding: 0px;">
    <p style="color: white; font-size:20px; font-family: Nunito-Light; ">Classwise Attendance</p>
  </div>
</div>
...
$('#datepicker').on('change',function(){
     ...
     $("#content").load('<?php echo site_url('principal/attendancebydate/'); ?>'+date);
  });  
</script>
</body>
</html>