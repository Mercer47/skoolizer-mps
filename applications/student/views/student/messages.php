...
<div class="col-xs-12" style="background: #ffffff; border-radius:16px; padding-top: 20px; margin-top: 20px; ">
  <?php foreach($messages as $row) { ?>
    ...
    <div class="col-xs-10" style="border-bottom: 1px solid; border-color: #515151;">
      <p style="text-transform: uppercase; font-family: Nunito-Semibold; font-size: 20px;">From: School<span style="float: right; font-size: 10px;"><?php 
      ...
      <p style="font-family: Questrial-Regular; color: #000000;">Attachments: <a href="<?php echo base_url('assets/images/messages/').$row->msgimage; ?>"><?php echo $row->msgimage; ?></a></p>
    </div>
    </div>
