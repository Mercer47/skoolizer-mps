...
<div class="col-md-12" style="padding: 30px;">
  <div class="col-md-12" style="font-family: RedhatR; font-size: 16px; border: 1px solid; border-color: #f95555; border-radius: 5px; padding-top: 10px; margin-bottom: 20px;">
    ...
    <p>Dear parent,<br>you are hereby requested to attend our PTM (Parent Teachers Meeting) on 7 Nov,2015 between 9:00 AM to 12:00 PM.<br>FBPS Desk</p>
  </div>
	 <form method="POST" action="<?php echo site_url('sms/sendptmsms'); ?>" enctype="multipart/form-data">
