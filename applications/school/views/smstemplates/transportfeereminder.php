...
<div class="col-md-12" style="padding: 30px;">
	 <form method="POST" action="<?php echo site_url('home/sendtransportfeereminder'); ?>" enctype="multipart/form-data">
<div class="col-md-12" style="margin-top: 30px;">
   ...
   <input type="text" name="period" placeholder="e.g Nov-Dec">
...
<div class="col-md-12">
    ...
    if ($key->Classname==$row->Class) { ?>
            <tr>
                <td>
                    <input type="checkbox" name="id[]" class="<?php echo $row->id; ?>" value="<?php echo $row->id; ?>" >
                </td>
