...
<div class="col-md-12" style="padding: 30px;">
  <div class="col-md-12" style="font-family: RedhatR; font-size: 16px; border: 1px solid; border-color: #f95555; border-radius: 5px; padding-top: 10px; margin-bottom: 20px;">
    ...
    <p>Dear parent,<br>School bus will be arriving 10 minutes early today. Kindly bear with us for inconvenience.<br>FBPS Desk</p>
  </div>
	 <form method="POST" action="<?php echo site_url('sms/sendbusdelaysms'); ?>" enctype="multipart/form-data">
<div class="col-md-12" style="margin-top: 30px;">
    <p style="font-family: Nunito_regular; font-size: 25px; color: black; text-align: center;">Select Recipients</p>
   <p class="details">Delay</p>
   <input type="text" name="delay" placeholder="e.g 10 minutes early/late">
