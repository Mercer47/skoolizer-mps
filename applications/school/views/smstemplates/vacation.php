...
<div class="col-md-12" style="padding: 30px;">
  <div class="col-md-12" style="font-family: RedhatR; font-size: 16px; border: 1px solid; border-color: #f95555; border-radius: 5px; padding-top: 10px; margin-bottom: 20px;">
    ...
    <p>Dear Parent, The Summer vacation starts from 5 May,2015 to 5 Jun,2015. Thanks. FBPS Desk</p>
  </div>
	 <form method="POST" action="<?php echo site_url('home/sendvacationsms'); ?>" enctype="multipart/form-data">
<div class="col-md-12" style="margin-top: 30px;">
   ...
   <p class="details">Vacation</p>
   <input type="text" name="vacation" placeholder="e.g Summer, Winter">
