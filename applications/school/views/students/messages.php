...
<?php foreach($info as $row) { ?>
	<div class="col-md-12" style=" border: 1px solid; border-radius: 5px; border-color: #EBEBEC; padding: 0px;">
		...
		<div class="col-md-12" style="padding: 20px;">
			...
			<p style="font-size: 30px; text-transform: uppercase; font-family: Nunito-Semibold;" align="center">Sent Messages</p>
			<?php foreach($messages as $key) { ?>
				<div class="col-md-12" style="margin-top: 30px;">
					<p style="font-family: RedhatR; font-size: 20px;">Message: <?php echo $key->message; ?></p>
			
			<p style="font-family: RedhatR; font-size: 20px;">Time: <?php $date=date('d F, Y H:i A',strtotime($key->sent_at)); echo $date; ?></p>
				</div>
