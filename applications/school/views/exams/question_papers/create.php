...
<script type="text/javascript">
	$(document).ready(function () {
		$('#table-view').load('<?php echo site_url('questionPaper/displayQuestions') ?>')
	});

	$('.filter').on('change', function () {
		if ($('#filter-check').is(':checked')) {
			$('#table-view').load('<?php echo site_url('questionPaper/filterquestions/') ?>' + $('#class').val() + '/' + $('#subject').val())
		}
	});
