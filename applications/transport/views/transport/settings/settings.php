...
<body style="background: white;">
  ...
  <div class="col-xs-12" align="center" style="padding-top: 30px;">
     <?php  foreach ($settings as $row) { $image=$row->image; } ?>
                <?php if ($image!=NULL) { ?>
                   <img src="<?php  echo base_url('assets/images/transport/').$row->image; ?>"  style="font-size: 60px;  border-radius: 50%; color: white; width: 150px; height: 150px; position: relative;top: 7px;">
                <?php } else { ?>
                    <i class='material-icons' style='color: white; font-size: 150px;  position: relative;top: 7px;'>account_circle</i>
                <?php } ?>  
                <br> 
  <button onclick="location.href='<?php echo site_url('transport/changeimage') ?>'" style="border: 2px solid white; background: transparent; outline: none; color: white; border-radius: 5px; font-family: Nunito_regular; padding: 5px; width: 50%; margin-top: 20px; font-size: 18px;"> Edit </button>
  </div>
</div>
<div class="col-xs-12" style="margin-top:20px;">
            <div class="col-xs-12" style="padding: 0 2px 0 2px;">
              <form>
                ...
                <input type="text" name="Fname" value="<?php echo $row->drivername; ?> ">
              </form>
   ...
   <a href="<?php echo site_url('transport/changepassword'); ?>" style="color:#875FD4; "><p style="font-size: 16px; padding-top: 0px; margin-bottom: 0px; color:#875FD4; font-family:Nunito_regular; padding:5px 0 5px 0 ; background: #f1f1f1; ">Change Password</p></a>
 </div>
